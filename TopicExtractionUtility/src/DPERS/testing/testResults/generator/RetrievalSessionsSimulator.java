		...
		for (File file : projectsList) {
			...
			if (file.isDirectory()) {				
				...
				for (int i=10; i<=50; i+=10) {
					...
					Constants.recommendationsOutputPath =  "F://SERL Internship//User Study Projects for Recommendation//Recommendations//" + Integer.toString(projectID)+"_"+Integer.toString(i)+"_"+Constants.keyWordstoGet+"_"+Boolean.toString(Constants.getKeywordsbyTopic)+".txt";					
					javaTotext.run(file);
