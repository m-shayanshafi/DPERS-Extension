...
/**
 * WordSimDBFacade, implementing several basic functionalies of using a word similarity database.
 */

public class WordSimDBFacade {
	 ...
	 */  
	public WordSimDBFacade(String dataFile) {	
